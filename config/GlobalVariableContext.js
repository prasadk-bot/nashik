...
export const AppVariables = {
  ...
  hi: {
    ...
    'B Phase Current (A)': 'बी चरण वर्तमान (ए)',
    'B Phase Voltage (V)': 'बी चरण वोल्टेज (वी)',
    'Check Ticket Status': 'टिकट की स्थिति जांचें',
    'Consumer Mobile App': 'उपभोक्ता मोबाइल ऐप',
    'R Phase Current (A)': 'आर चरण वर्तमान (ए)',
    'R Phase Voltage (V)': 'आर चरण वोल्टेज (वी)',
    'Ref Registration No': 'संदर्भ पंजीकरण संख्या',
    'Subject is required': 'विषय आवश्यक है',
    'Update Phone Number': 'फ़ोन नंबर अपडेट करें',
    'Y Phase Current (A)': 'वाई चरण वर्तमान (ए)',
    'Y Phase Voltage (V)': 'वाई चरण वोल्टेज (वी)',
    ...
    'Current Reading (KVAH)': 'वर्तमान रीडिंग (केवीएएच)',
